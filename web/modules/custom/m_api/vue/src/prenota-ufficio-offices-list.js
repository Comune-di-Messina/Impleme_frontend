import Vue from "vue";
import PrenotaUfficioOfficesList from "./PrenotaUfficioOfficesList.vue";
...
Vue.component("PrenotaUfficioOfficesList", PrenotaUfficioOfficesList);
...
const app = new Vue({
  el: "#vueapp",
  template: "<prenota-ufficio-offices-list />"
});
