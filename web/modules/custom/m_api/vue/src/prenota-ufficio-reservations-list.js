import Vue from "vue";
import PrenotaUfficioReservationsList from "./PrenotaUfficioReservationsList.vue";
...
Vue.component("PrenotaUfficioReservationsList", PrenotaUfficioReservationsList);
...
const app = new Vue({
  el: "#vueapp",
  template: "<prenota-ufficio-reservations-list />"
});
